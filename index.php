...
<body>
    <?php 
        include("header.php");
        include("toggle.php");
        include("illustrationPagePrincipale.php");
        include("sectionArticles.php");
        include("SectionServices.php");
        include("sectionTeam.php");
        include("sectionLaisserSMS.php");
        include("sectionPartenaires.php");
        include("footer.php");
